...
internal var overRide = false; // emergency override if cam change is bad idea
...
//moving menu
internal var rollCredits = false;
private var vPos =  0.0;
internal var base = 1000.0; 
internal var end = false;  //end sequence 
...
function OnGUI () {
	...
	if (rollCredits) {
	   ...
	   GUI.BeginGroup(Rect (Screen.width / 2 - 200, vPos, 400, 600));

	   GUI.Box (Rect (0,20,400,500), "The End");

	   GUI.Label( Rect (20,40,200,100), "Credits listed here");
